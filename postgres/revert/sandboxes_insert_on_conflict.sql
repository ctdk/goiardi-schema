-- Revert goiardi_postgres:sandboxes_insert_on_conflict from pg

BEGIN;

DROP FUNCTION IF EXISTS goiardi.merge_sandboxes(m_sbox_id varchar(32), m_creation_time timestamp with time zone, m_checksums jsonb, m_completed boolean, m_organization_id bigint);
