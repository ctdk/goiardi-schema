-- Revert goiardi_postgres:shovey_insert_on_conflict from pg

BEGIN;

DROP FUNCTION IF EXISTS goiardi.merge_shoveys(m_run_id uuid, m_command text, m_status text, m_timeout bigint, m_quorum varchar(25), m_organization_id bigint);
